...
using OrderSystemLibrary.Annotations;
...
namespace OrderSystemLibrary.Data
{
    public class Order : INotifyPropertyChanged
    {
        ...
        public Order(int id, DateTime time, DateTime created, User admin, bool closed, DateTime closedTime, int userId)
        {
            this.id = id;
            this.time = time;
        ...
        public static Order Parse(DataRow row, int userId, bool parseAdmin = false)
        {
            ...
            return new Order(id, time, created, adminUser, closed, closedTime, userId);
        }
        ...
        public string TimeFormattedWithIndicator
        {
            get
            {
                ...
                if (productLineModel.HasAlreadyOrdered(userId, Id))
                {
